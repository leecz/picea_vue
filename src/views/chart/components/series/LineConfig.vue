  ...
  <div class="mt3">
    <el-form size="mini" label-width="80px">
      ...
      <el-form-item label="平滑曲线">
        <el-switch v-model="form.smooth" @change="smoothChange"></el-switch>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    showSymbolChange() {
      this.commitChange(
        `series[${this.seriesIndex}].showSymbol`,
        this.form.showSymbol
      );
    },
    smoothChange() {
      this.commitChange(`series[${this.seriesIndex}].smooth`, this.form.smooth);
    },
    symbolChange() {
